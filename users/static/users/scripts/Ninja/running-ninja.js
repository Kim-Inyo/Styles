export class NinjaRun {
    constructor(img, stageWidth) {
        ...
        this.ninjaWidth = 200;
        this.ninjaHeight = 200;

        this.ninjaWidthHalf = this.ninjaWidth / 2;
        this.x = -this.ninjaWidth;
        this.y = 0;
        this.speed = Math.random() * 2 + 4;

        this.fps = 24 + this.speed;
    ...
    animate(ctx, dots) {
        this.x += this.speed;
        if (this.x < -this.ninjaWidth) this.x = this.stageWidth + this.ninjaWidth;
        ...
        ctx.drawImage(
            this.img,
            this.imgWidth * this.curFrame + 50,
            50,
            100,
            80, -this.ninjaWidthHalf, -this.ninjaHeight,
            this.ninjaWidth,
            this.ninjaHeight
        );
